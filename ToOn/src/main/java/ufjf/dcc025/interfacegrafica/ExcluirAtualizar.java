...
public class ExcluirAtualizar implements ActionListener, MouseListener {
    ...
    public ExcluirAtualizar(String nomeUsuario, String tituloShow, String filmeOUserie) {
        ...
        // frame
        frame.setTitle("Tô On - Excluir ou Atualizar");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == botaoAtualizar) {
            frame.dispose();
            new PaginaEditarShow(usuarioAtivo, tituloS, categoria);
        } else if (ae.getSource() == botaoVoltar) {
            frame.dispose();
            new MenuAssistindo(usuarioAtivo);
        } else if (ae.getSource() == botaoExcluir) {
            
            //apaga um show do banco de dados chamando seu metodo
